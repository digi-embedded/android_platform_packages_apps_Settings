...
public class CloudConnectorSettings extends SettingsPreferenceFragment
        implements Indexable, SwitchBar.OnSwitchChangeListener, ICloudConnectorEventListener {

    // Constants.
    // For Search
    public static final String DATA_KEY_REFERENCE = "main_toggle_cc";
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        new BaseSearchIndexProvider() {
            ...
            public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
                ...
                if (res.getBoolean(R.bool.config_show_cc_settings)) {
                    SearchIndexableRaw data = new SearchIndexableRaw(context);
                    data.title = res.getString(R.string.cc_settings);
                    data.screenTitle = res.getString(R.string.cc_settings);
                    data.keywords = res.getString(R.string.keywords_cc);
