...
public class CCEnabler implements SwitchWidgetController.OnSwitchChangeListener, ICloudConnectorEventListener {
    ...
    public CCEnabler(Context context, SwitchWidgetController switchWidget,
        ...
        mCCManager = new CloudConnectorManager(context);
