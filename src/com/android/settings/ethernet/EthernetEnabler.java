...
public class EthernetEnabler implements SwitchWidgetController.OnSwitchChangeListener {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ConnectivityManager.CONNECTIVITY_ACTION.equals(action)) {
                mConnected.set(mEthernetManager.isEnabled());
                handleEthernetStateChanged(mEthernetManager.isEnabled());
            }
        }
    };
    ...
    public EthernetEnabler(Context context, SwitchWidgetController switchWidget,
        ...
        mEthernetManager = new EthernetManager(mContext);
    ...
    public void setupSwitchController() {
        final boolean state = mEthernetManager.isEnabled();
    ...
    public boolean onSwitchToggled(boolean isChecked) {
        ...
        mEthernetManager.setEnabled(isChecked);
